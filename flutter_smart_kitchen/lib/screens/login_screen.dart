...
//                         if (!success) {
//                           if (!mounted) return;  // Guard immediately before context
...
// // Updated login_screen.dart - More branded with gradient background, logo placeholder, and smooth animations
// import 'package:flutter/material.dart';
// import 'package:provider/provider.dart';
// import '../services/firebase_service.dart';
...
//             colors: [Color(0xFFFFA726), Color(0xFFFF7043)], // Warm kitchen oranges
//           ),
//         ),
//         child: SafeArea(
...
//                         ],
//                       ),
//                       child: const Icon(Icons.kitchen, size: 80, color: Color(0xFFFF5722)),
//                     ),
//                   ),
...
//                   ),
//                   const Text(
//                     "Monitor your appliances smarter",
...
//                               width: 20,
//                               height: 20,
//                               child: CircularProgressIndicator(strokeWidth: 2, valueColor: AlwaysStoppedAnimation<Color>(Color(0xFFFF5722))),
//                             )
